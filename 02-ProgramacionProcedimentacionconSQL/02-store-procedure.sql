...
--Crear un sp con parametros de entrada y salida, para calcular el area de un triangula

CREATE OR ALTER PROC spu_area_triangulo
    @b INT,
    @h INT,
    @area INT OUTPUT
AS
...
DECLARE @areaTriangulo INT;
EXEC spu_area_triangulo 10,5, @areaTriangulo OUTPUT;
SELECT @areaTriangulo AS [AREA];
GO
...
BEGIN
    ...
    BEGIN
        THROW 50001, 'EL CLIENTE NO EXITSE',1;
    END
